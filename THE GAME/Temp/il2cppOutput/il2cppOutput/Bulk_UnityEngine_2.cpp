...
IL_0043:
	{
		...
		NullCheck(L_11);
		GcLeaderboard_Internal_LoadScores_m3812892801(L_11, L_13, L_16, L_19, L_20, L_22, L_24, /*hidden argument*/NULL);
		return;
	}
}
...
extern "C"  void GcLeaderboard_Internal_LoadScores_m3812892801 (GcLeaderboard_t453887929 * __this, String_t* ___category0, int32_t ___from1, int32_t ___count2, StringU5BU5D_t1642385972* ___userIDs3, int32_t ___playerScope4, int32_t ___timeScope5, const MethodInfo* method)
{
	typedef void (*GcLeaderboard_Internal_LoadScores_m3812892801_ftn) (GcLeaderboard_t453887929 *, String_t*, int32_t, int32_t, StringU5BU5D_t1642385972*, int32_t, int32_t);
	static GcLeaderboard_Internal_LoadScores_m3812892801_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (GcLeaderboard_Internal_LoadScores_m3812892801_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.SocialPlatforms.GameCenter.GcLeaderboard::Internal_LoadScores(System.String,System.Int32,System.Int32,System.String[],System.Int32,System.Int32)");
...
extern "C"  bool TouchScreenKeyboard_get_isSupported_m798827778 (Il2CppObject * __this /* static, unused */, const MethodInfo* method)
{
	...
	int32_t V_1 = 0;
	{
		...
		V_1 = L_1;
		int32_t L_2 = V_1;
		switch (((int32_t)((int32_t)L_2-(int32_t)((int32_t)18))))
		{
			case 0:
			{
				goto IL_0068;
...
IL_002a:
	...
	}
	{
		...
		Uri_t19570940 * L_12 = V_0;
		NullCheck(L_12);
		String_t* L_13 = Uri_get_Host_m395387191(L_12, /*hidden argument*/NULL);
...
IL_009f:
	{
		...
		NullCheck(L_29);
		String_t* L_30 = Uri_get_OriginalString_m2475338851(L_29, /*hidden argument*/NULL);
		return L_30;
	}
}
#ifdef __clang__
